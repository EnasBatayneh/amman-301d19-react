...
// The constructor can't be converted to an arrow functions.
...
// TODO: After viewing the previous console.log(), return the code to a working state.
// The prototype can't be converted to an arrow functions.
...
//
// 3. Explain why "this" is different when an arrow function is used: this is refer to a parent , and once we use it in an arrow function, it refered to the document (window).
